...
#  validates_numericality_of :latitude, :longitude
  ...
  def import
    ...
    if gpx.actual_points > 0
      ...
      max_lat = max_lat.to_f / 10000000000000000
      min_lat = min_lat.to_f / 10000000000000000
      max_lon = max_lon.to_f / 10000000000000000
      min_lon = min_lon.to_f / 10000000000000000

...
class NodeControllerTest < ActionController::TestCase
  ...
  def test_create
    ...
    # compare values
    assert_in_delta lat * 10000000000000000, checknode.latitude, 1, "saved node does not match requested latitude"
    assert_in_delta lon * 10000000000000000, checknode.longitude, 1, "saved node does not match requested longitude"
